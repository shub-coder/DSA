/*Efficient Approach The process might begin with 
merging arrays into groups of two. After the 
first merge, we have k/2 arrays. Again merge 
arrays in groups, now we have k/4 arrays. This 
is similar to merge sort. Divide k arrays into 
two halves containing an equal number of arrays 
there are two arrays in a group. This is followed
 by merging the arrays in a bottom-up manner. */
